...
.vue-flow__handle {
  /* The component-level .connection-handle rule in BaseNode.vue sets
     the actual visual size + the hit-area child element. This global
     rule is kept as a fallback for any handle that isn't a BaseNode. */
