...
For the public documentation site (installation, tutorials, node reference, API), see [docs.github.com/maharsolution/m9m/tree/main/docs/m9m](https://docs.github.com/maharsolution/m9m/tree/main/docs/m9m) — source under [`documentation/`](../documentation/).
