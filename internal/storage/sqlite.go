...
func (s *SQLiteStorage) CountWorkflows(filters WorkflowFilters) (int, error) {
	var conditions []string
	var args []interface{}
...
func (s *SQLiteStorage) CountExecutions(filters ExecutionFilters) (int, error) {
	var conditions []string
	var args []interface{}
...
// and success rate.
func (s *SQLiteStorage) RecentExecutions(filters ExecutionFilters, limit int) ([]*model.WorkflowExecution, error) {
	if limit <= 0 {
		limit = 200
	}
